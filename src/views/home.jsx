...
const Home =()=>{
    return(
        <div>
            <div className="flex flex-wrap items-center py-5 md:py-10">
                    ...
                    <div className="">
                        ...
                        <div className="flex mx-10 flex-wrap items-center justify-center">
                            <div className="flex justify-center pt-5 lg:w-2/3 lg:pt-0">
                                <img src={image} alt="" className="h-auto w-auto m-auto"></img>
                            </div>
                            <div className="items-center text-center lg:w-1/3">
